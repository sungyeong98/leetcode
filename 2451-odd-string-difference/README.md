<h2><a href="https://leetcode.com/problems/odd-string-difference/">2451. Odd String Difference</a></h2><h3>Easy</h3><hr><p>You are given an array of equal-length strings <code>words</code>. Assume that the length of each string is <code>n</code>.</p>
